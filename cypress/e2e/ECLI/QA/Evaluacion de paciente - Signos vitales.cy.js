...
import { agregarDiagnosticoDeSalida, agregarMotivoDeConsultra, agregarSignosVitales } from "../../../funciones/ECLI/evaluacion";
...
describe('template spec', () => {
  it('Evaluación de paciente - Signos vítales', () => {
    let numero = 0;
    let botonMasNuevo = 0;
