...
import { agregarDiagnosticoDeSalida, agregarExploracionFisica, agregarMotivoDeConsultra } from "../../../funciones/ECLI/evaluacion";
...
describe('template spec', () => {
  it('Evaluación de paciente - Exploración física', () => {
    let numero = 0;
    let botonMasNuevo = 0;
