...
import { agregarDiagnosticoDeSalida, agregarMotivoDeConsultra, agregarNotasClinicas } from "../../../funciones/ECLI/evaluacion";
...
describe('template spec', () => {
  it('Evaluación de paciente - Notas clínicas', () => {
    let numero = 0;
    let botonMasNuevo = 0;
