...
import {
  agregarDiagnosticoDeSalida,
  agregarMotivoDeConsultra,
} from "../../../funciones/ECLI/evaluacion";
...
import { agregarOrdenesDeMedicamentos } from "../../../funciones/ECLI/ordenes";

describe("template spec", () => {
  it("Agregar una nueva orden de Medicamentos", () => {
    let numero = 0;
    let botonMasNuevo = 0;
