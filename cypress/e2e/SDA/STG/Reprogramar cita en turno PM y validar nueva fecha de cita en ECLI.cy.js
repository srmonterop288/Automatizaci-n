...
describe("Reprogramar cita en turno PM y validar nueva fecha de cita en ECLI", () => {
...
cy.get('#turn input[type="radio"][value="PM"]').check({ force: true });
...
cy.wait(1000).tab()
  ...
  cy.log(`Contador: ${contador}, DNI: ${DNI}`);
        ...
        cy.log(`Contador: ${contador}, DNI: ${DNI}`);
            cy.screenshot(
      "Reprogramar cita_STG/Nueva fecha PM_" +
