...
describe("Reprogramar cita en turno AM y validar nueva fecha de cita en ECLI", () => {
...
cy.get('#turn input[type="radio"][value="AM"]').check({ force: true });
cy.get('#ddl_Modal_Reagendar_Cita_Motivo').click({ force: true });
...
cy.wait(1000).tab()
  ...
  cy.log(`Contador: ${contador}, DNI: ${DNI}`);
      ...
      cy.log(`Contador: ${contador}, DNI: ${DNI}`);
            cy.screenshot(
      "Reprogramar cita_STG/Nueva fecha AM_" +
