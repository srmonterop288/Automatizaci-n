...
describe(" Generar cita común de tipo OTRO", () => {
...
cy.get('.ant-select-dropdown .ant-select-item-option')
  ...
  cy.get('input[type="radio"][value="OTRO"]', { timeout: 10000 })  // Selecciona el radio button con el valor "NUEVO"
  .check(); 
  ...
  cy.log(`Contador: ${contador}, DNI: ${DNI}`);
    ...
    cy.log(`Contador: ${contador}, DNI: ${DNI}`);
            cy.screenshot(
      "Generar cita comun_QA/tipo OTRO_" +
