...
<<<<<<< HEAD:cypress/e2e/SDA/QA/Agenda diaria flujo completo.cy.js
...
=======
  ...
  it("debería iniciar sesión con éxito", () => {
    ...
    cy.wait(1000);
    cy.get("#div_nombre_usuario", { timeout: 10000 })
      .should("be.visible")
      .click();
    cy.get("#div_menu_cambiar_cuenta", { timeout: 10000 })
      .should("be.visible")
      .click();
    cy.get("#div_seleccionar_rol_supervisor_de_tramites_y_citas", {
      timeout: 10000,
>>>>>>> 0876d1310b384d733a7a3eb67f42614dd6383c07:cypress/e2e/SDA/Agenda diaria flujo completo.cy.js
    })
      .should("be.visible")
      .click();
    ...
    cy.get("#btn_menu_desplegable").should("be.visible").click();
    cy.wait(1000);
    cy.get("#spn_modulo_unidades_ejecutoras_agendas")
      .should("be.visible")
      .click();
    cy.wait(1000);
    cy.get("#btn_menu_desplegable").should("be.visible").click();
    ...
    cy.xpath('//*[@id="select_Agendas_Personal_Salud_list_0"]').should(
      "be.visible"
    );
    ...
    cy.get("#select_Agendas_Personal_Salud")
      ...
      .then((doctor) => {
        ...
        cy.wait(500);
        cy.get(
          "#ddl_Creando_Agenda_Consultorio_Martes_list .ant-select-item-option"
        ...
        cy.get("#btn_Creando_Agenda_Crear")
          .scrollIntoView()
          .should("be.visible")
          .click();
        cy.wait(1000);
        ...
        cy.get("#btn_menu_desplegable").should("be.visible").click();
        cy.wait(1000);
        cy.get("#spn_modulo_unidades_ejecutoras_asignaciondecitas")
          .should("be.visible")
          .click();
        cy.wait(1000);
        cy.get("#spn_submodulo_unidades_ejecutoras_citas")
          .should("be.visible")
          .click();
        cy.wait(1000);
