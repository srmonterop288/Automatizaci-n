...
import { transcripciónRecetaTitulada } from '../../../funciones/MEIN/verificacionReceta';
  ...
  it("Pruebas", () => {
    ...
    cy.readFile("cypress/fixtures/numeroDeReceta.json").then((data) => {
      ...
      if (idoneaDelPaciente != "" && receta != "") {
        transcripciónRecetaTitulada(idoneaDelPaciente, contrasenaConcatenada, numeroRecetaConcatenada)
